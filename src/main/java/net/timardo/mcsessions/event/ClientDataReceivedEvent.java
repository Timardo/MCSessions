...
/**
 * This event is fired whenever a client receives an ISessionClientData object through ClientReceiverThread from the session server.
 ...
 */
@Cancelable
public class ClientDataReceivedEvent extends Event {
	
	private final ISessionClientData receivedData;
	
	public ClientDataReceivedEvent(ISessionClientData data) {
